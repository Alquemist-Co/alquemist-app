...
- **Fases**: 5 (0-4)
- **Semanas**: 20
- **Planned**: 175 | **In Progress**: 5 | **Done**: 38
...
| ID | Feature | Stories | Priority | Status | Doc |
|----|---------|---------|----------|--------|-----|
| F-011 | Configuracion de tipos de cultivo y fases | 5 | P0 - Critical | In Progress | [F-011](./in-progress/F-011-crop-types-config.md) |
